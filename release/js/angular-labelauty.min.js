  ...
  return {
    ...
    link: function link(scope, element, attrs, ngModelCtrl) {
      ...
      function _compileAndReplaceElement() {
        ...
        var innerEl = angular.element('<div class="labelauty-inner btn btn-default" ng-class="{ \'active\' : checked, \'disabled\' : disabled }" ng-click="toggleModelValue($event)" ng-class="{ \'disabled\' : disabled }">\n            <i class="labelauty-inner-icon fa" ng-class="{ \'fa-check\' : checked, \'fa-circle\' : !checked }"></i>\n            <span>{{ label }}</span>\n            </div>');
